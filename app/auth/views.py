...
'''
The login.html is searched relatively i:e inside app/templates/auth/login.html
'''
...
3) " request.endpoint[:5] != 'auth.'  "  This says that, block unconfirmed user if he is trying to access URL other than
  inside "app/templates/auth/"
'''
...
def resend_confirmation():
    ...
    send_email(current_user.email, 'Damru: Confirm your account', 'auth/email/confirm', user=current_user, token=token)
